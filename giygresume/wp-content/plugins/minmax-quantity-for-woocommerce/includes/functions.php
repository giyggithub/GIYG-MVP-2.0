...
if( ! function_exists( 'br_mm_quantity_option_callback' ) ) {
    /**
     * Function for settings callback
     *
     * @return void
     */
    function br_mm_quantity_option_callback() { 
        include MM_QUANTITY_TEMPLATE_PATH . "general_settings.php";
    }
}
...
if ( ! function_exists( 'berocket_font_select_upload' ) ) {
    ...
    function berocket_font_select_upload( $text, $id, $name, $value, $show_fa = true, $show_upload = true, $show_remove = true, $data_sc = '' ) {
        ...
        if ( $show_fa ) {
            $result .= '<input type="button" class="berocket_aapf_font_awesome_icon_select button" value="'.__('Font awesome', 'BeRocket_MM_Quantity_domain').'"/>
        ...
        if ( $show_upload ) {
            $result .= '<input type="button" class="berocket_aapf_upload_icon button" value="'.__('Upload', 'BeRocket_MM_Quantity_domain').'"/> ';
        }
        if ( $show_remove ) {
            $result .= '<input type="button" class="berocket_aapf_remove_icon button" value="'.__('Remove', 'BeRocket_MM_Quantity_domain').'"/>';
        }
        $result .= '</div>';
