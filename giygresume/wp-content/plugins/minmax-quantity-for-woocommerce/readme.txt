...
Tags: limit quantity, woocommerce limits, range to buy, min and max to purchase, product limits to buy, products min, products max, set min and max, woocommerce min and max
...
= Paid Plugin Link =
http://berocket.com/product/woocommerce-minmax-quantity

= Demo =
http://woocommerce-product-of-day.berocket.com/shop/

= Demo Description =
http://woocommerce-product-of-day.berocket.com/minmax-quantity-preview/
...
== Screenshots ==
1. General settings
2. Limitation for product
3. Limitation for product variation
