...
$tcvpb_elements['image_switch_tc'] = array(
	'name' => esc_html__('Image Switch', 'ABdev_revelance' ),
	'type' =>  'block',
	'icon' => 'pi-image-swich',
	...
	'attributes' => array(
		'url' => array(
			'type' => 'image',
			'description' => esc_html__('First Image', 'ABdev_revelance'),
			'divider' => 'true',
		),
		'url_second' => array(
			'type' => 'image',
			'description' => esc_html__('Second Image', 'ABdev_revelance'),
		),
		'animation' => array(
			'default' => '',
		...
		'link' => array(
			...
			'type' => 'url',
			'tab' => esc_html__('Link', 'ABdev_revelance'),
		),
		'target' => array(
