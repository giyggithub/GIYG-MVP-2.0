...
if ( $order ) : ?>
    ...
    <div class="thank_submit">
        <?php if(!empty($_SESSION['pre_back_url'])) { ?>
            <a class="btn btn-lg btn-green" href="<?php echo esc_url( remove_query_arg( 'survey-status',  $_SESSION['pre_back_url'] ) ); ?>"><span>FINISH GIYGGRAPH DESIGN</span></a>
        <?php } else { ?>
            <a class="btn btn-lg btn-green" href="<?php echo get_site_url();?>/my-account/my-giyg/"><span>FINISH GIYGGRAPH DESIGN</span></a>
        <?php } ?>
    </div>
    <hr>
