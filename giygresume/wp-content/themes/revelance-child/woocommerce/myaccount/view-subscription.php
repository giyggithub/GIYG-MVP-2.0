...
<?php if ($subscription->get_status() == 'cancelled' || $subscription->get_status() == 'pending-cancel'): ?>
	<p>Your GIYG account has been cancelled. We are very sorry to see you go.</p>
    <p>You will not be billed further.</p>
    <p>Thank you for using GIYG!  If you have any suggestions or feedback, please email us at info@giyg.me .  It's very much appreciated.</p>
    <p>If you see an unauthorized charge on your statement, please contact us IMMEDIATELY at info@giyg.me</p>
    <p>Thank you for your business.</p>
    <p>The GIYG Team</p>
    <p><strong>**Please check your inbox for a cancellation email. If you don't receive it, make sure to check your spam folder as well**</strong></p>
	...
	<?php if ( ! empty( $actions ) ) : ?>
		<tr>
			...
			<td>
				...
				<?php endforeach; ?>
				<a href="<?php echo get_site_url() . "/pricing" ; ?>" class="button subscriptio_button">Change Subscription</a>
			</td>
		</tr>
	<?php endif; ?>
