...
?>
	<section class="page_main_section">
		<div class="container">
			...
			<h1 class="main_title"><span><?php esc_html_e('FROM THE BLOG', 'ABdev_revelance'); ?></span></h1>
				...
				<div class="span8 content_with_right_sidebar">
					<?php if (have_posts()) :  while (have_posts()) : the_post();
						...
						<div class="post_content">
								...
								<div class="post_meta">
									<span class="post_date"><i class="ci_icon-clock"></i><?php the_date();?></span>
									<span class="post_tags"><i class="ci_icon-folder"></i><?php the_tags();?></span>
									<span class="post_author"><i class="ci_icon-user"></i>By <?php the_author();?></span>
								</div>
	...
	<?php
	$content_after_single_post = get_theme_mod('content_after_single_post','');
	if($content_after_single_post!=''){
		echo do_shortcode($content_after_single_post);
	}
	?>
