...
if( in_array('real3d-flipbook/real3d-flipbook.php', get_option('active_plugins')) ){ //first check if plugin is installed
	...
	$tcvpb_elements['real3dflipbook'] = array(
		'name' => esc_html__('Real3D Flipbook', 'ABdev_revelance' ),
		'description' => esc_html__('Real3D Flipbook', 'ABdev_revelance'),
		'type' => 'block',
		'icon' => 'pi-flipbook',
		...
		'attributes' => array(
			'id' => array(
				'description' => esc_html__('Select Flipbook', 'ABdev_revelance'),
				'default' => '',
				'type' => 'select',
				'values' => $books,
