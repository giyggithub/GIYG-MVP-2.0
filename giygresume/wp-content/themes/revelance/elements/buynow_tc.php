...
$tcvpb_elements['buynow_tc'] = array(
	'name' => esc_html__('BuyNow PayPal Button', 'ABdev_revelance' ),
	'type' => 'block',
	'icon' => 'pi-paypal',
	'category' => esc_html__('E-Commerce', 'ABdev_revelance' ),
	'attributes' => array(
		'email' => array(
			'description' => esc_html__('Your Email', 'ABdev_revelance'),
		),
		'lc' => array(
			'default' => 'US',
			'description' => esc_html__('Locale', 'ABdev_revelance'),
			'divider' => 'true',
		),
		'item_name' => array(
			'description' => esc_html__('Item Name', 'ABdev_revelance'),
		),
		'item_number' => array(
			'description' => esc_html__('Item Number', 'ABdev_revelance'),
		),
		'price' => array(
			'description' => esc_html__('Item Price', 'ABdev_revelance'),
			'divider' => 'true',
		),
		'currency' => array(
			'default' => 'USD',
			'description' => esc_html__('Currency', 'ABdev_revelance'),
		),
		'creditcard' => array(
			'default' => '0',
			'description' => esc_html__('Show credit cards', 'ABdev_revelance'),
			'type' => 'checkbox',
		),
		'tax_rate' => array(
			'default' => '0',
			'description' => esc_html__('Tax Rate', 'ABdev_revelance'),
		),
		'shipping' => array(
			'default' => '0',
			'description' => esc_html__('Shipping Cost', 'ABdev_revelance'),
		),
		'id' => array(
