...
if (class_exists('WP_Customize_Control')){
	...
	class Multi_Input_Custom_control extends WP_Customize_Control{
		...
		public function render_content(){ 
			...
			<label class="customize_multi_input">
				...
				<a href="#" class="button button-primary customize_multi_add_field"><?php _e('Add More', 'ABdev_revelance') ?></a>
			</label>
			<?php
		}
	}
	...
	class Revelance_Toggle_Checkbox_Custom_control extends WP_Customize_Control{
