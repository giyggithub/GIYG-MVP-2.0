...
$tcvpb_elements['chart_radar_tc'] = array(
	'name' => esc_html__('Chart Radar', 'ABdev_revelance' ),
	'type' => 'block',
	'icon' => 'pi-chart-radar',
	...
	'attributes' => array(
		...
		'labels' => array(
			'description' => esc_html__('Labels', 'ABdev_revelance'),
			'info' => esc_html__('Type labels with commas and without spaces(e.g. Eating,Drinking,Sleeping,Designing,Coding,Cycling,Running)', 'ABdev_revelance'),
		),
		'id' => array(
...
$tcvpb_elements['chart_radars_tc'] = array(
	...
	'attributes' => array(
		...
		'pointcolor' => array(
			'description' => esc_html__('Point Color', 'ABdev_revelance'),
			'type' => 'color',
			'default' => 'rgba(220,220,220,1)',
		),
		'pointstrokecolor' => array(
			'description' => esc_html__('Point Stroke Color', 'ABdev_revelance'),
			'type' => 'color',
			'default' => '#fff',
		),
		'pointhighlightFill' => array(
			'description' => esc_html__('Point Highlight Fill Color', 'ABdev_revelance'),
			'type' => 'color',
			'default' => '#fff',
		),
		'pointhighlightstroke' => array(
			'description' => esc_html__('Point Highlight Stroke Color', 'ABdev_revelance'),
			'type' => 'color',
			'default' => 'rgba(220,220,220,1)',
		),
		'data' => array(
			'description' => esc_html__('Radar Points', 'ABdev_revelance'),
