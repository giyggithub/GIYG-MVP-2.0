...
elseif(get_query_var('post_type')=='portfolio'){
	$ABdev_revelance_title_bar_title = __('Portfolio','ABdev_revelance');
}
elseif(is_author()){
...
elseif(is_month()){
	...
	if (get_query_var('m') == '') {
		$ABdev_revelance_title_bar_title = __('Posts on ','ABdev_revelance').' '.date('M Y',strtotime($newmonth));
	}
}
...
?>
						...
						<?php $custom = get_post_custom();?>
							<div <?php post_class('post_wrapper clearfix');?>>
								<div class="post_content">
									...
									<div class="post_meta">
										<span class="post_date"><i class="ci_icon-clock"></i><?php echo get_the_date();?></span>
	...
	<?php
	$content_after_category = get_theme_mod('content_after_category','');
	if($content_after_category!=''){
		echo do_shortcode($content_after_category);
	}
	?>
