...
define( 'THEMENAME', 'Revelance' );

require_once dirname( __FILE__ ) . '/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'revelance_register_required_plugins' );

function revelance_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'The Creator - Visual Page Builder', // The plugin name
			'slug'     				=> 'the-creator-vpb', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/inc/plugins/the-creator-vpb.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
	...
	$theme_text_domain = 'ABdev_revelance';
