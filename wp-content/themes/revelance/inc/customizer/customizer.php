...
function customizer_admin_menu_link() {
    add_menu_page( 'Customize', 'Customize Theme', 'edit_theme_options', 'customize.php', '', 'dashicons-art', 101 );
}
	...
	**/
	$wp_customize->add_section('section_general', array(
		...
		**/
		...
		$wp_customize->add_control('disable_responsiveness', array(
		...
		**/
		...
		$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'favicon', array(
			'label'     => __( 'Favicon', 'ABdev_revelance' ),
			'settings'  => 'favicon',
			'section'   => 'section_general',
		)));
		...
		**/
		...
		$wp_customize->add_control('custom_css', array(
			'label'    => __('Custom CSS', 'ABdev_revelance'),
			'description'   => __('Here you can place additional CSS or CSS to override theme\'s styles', 'ABdev_revelance'),
			'type'     => 'textarea',
			'section'  => 'section_general',
		));
		...
		**/
		...
		$wp_customize->add_control('boxed_body', array(
	...
	**/
	$wp_customize->add_section('section_icons', array(
		...
		**/
		...
		$wp_customize->add_control('disable_icon_font', array(
	...
	**/
	$wp_customize->add_section('section_global_colors', array(
		...
		**/
		...
		$wp_customize->add_control('dark_scheme', array(
	...
	**/
	$wp_customize->add_section('section_footer', array(
		...
		**/
		...
		$wp_customize->add_control('hide_back_to_top', array(
