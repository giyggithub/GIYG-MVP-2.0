jQuery(document).ready(function($) {
    ...
    var tinymce_options = {
        ...
        plugins: "paste link hr image charmap searchreplace table textcolor",
        paste_as_text: true,
    ...
    *********************************************************************************************/
    ...
    function tcvpb_element_html(shortcode,title,excerpt){
        excerpt = (excerpt!==undefined) ? $('<div>'+excerpt.replace(/</g,' <').replace(/>/g,'> ').replace(/\[/g,' <').replace(/\]/g,'> ').replace(/\*quot\*/g, '"')+'</div>').text().replace(/[^\w\s]/g, '') : '';
        var tc_element_html = ''+
    ...
    function tcvpb_save_section_settings(e) {
        ...
        $editing_section.find('.tcvpb_section_heading h4').html(section_title);
    ...
    function tcvpb_attribute_fields(attribute_name, attribute, value){
        ...
        var attribute_fields = '<div class="tcvpb_shortcode_attribute_row'+((attribute.type=='hidden')?' hidden':'')+class_out+'"'+tab_out+'><label for="tcvpb_shortcode_attribute_'+attribute_name+'">'+attribute.description+'</label><div class="attribute">';
        var set_value = '';
